...
const CreatorDashboard = () => {
  ...
  const { metrics, campaigns, recentDonations, monthlyFundraising, badges = [], notifications = [], gamification, donations = [] } = data;
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {activeTab === 'contributionHistory' && (
            <div className="bg-white card-shadow border border-darkborder rounded-2xl p-6 space-y-6 animate-fadeIn">
